...
@Component({
  selector: 'app-visit-owner-detail',
  templateUrl: './visit-owner-detail.component.html',
  styleUrls: ['./visit-owner-detail.component.css']
})
export class VisitOwnerDetailComponent implements OnInit {
